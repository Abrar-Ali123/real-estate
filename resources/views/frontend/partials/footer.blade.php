    ...
    <div class="container">
        <div class="row">
            <div class="col m4 s12">
                <h5 class="white-text uppercase">معلومات عنا</h5>
            ...
            <div class="col m6 s12">
                <h5 class="white-text uppercase">العقارات الأخيرة</h5>
                <ul class="collection border0">
                    ...
                    <li class="collection-item transparent clearfix p-0 border0">
                        ...
                        <div class="float-left">
                            ...
                            <p class="m-t-0 m-b-5 grey-text text-lighten-1"> : غرف النوم  {{ $property->bedroom }} Bathroom: {{ $property->bathroom }} </p>
                        </div>
                    </li>
                    @endforeach
